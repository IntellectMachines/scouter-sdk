...
Scouter wraps your AI agent clients to intercept, evaluate, and govern every action before it executes — stopping rogue tool calls, prompt injections, and policy violations in real time.
...
```env
SCOUTER_BACKEND_URL=https://your-scouter-backend.example.com
